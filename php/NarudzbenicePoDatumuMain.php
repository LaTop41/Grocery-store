...
if (isset($_POST['btnPregledPoDatumu'])) {
	...
	$Datum = $_POST['datumNarudz'];
	$trazeniDat = new DateTime($Datum); 

	$upit = "SELECT n.*, k.* FROM narudzbenica n  JOIN korisnik k ON n.idKorisnik = k.idKorisnik WHERE DATE(n.datumVreme) = '" .  $Datum  . "'";
	...
	if( mysqli_num_rows($rez) <= 0){
		...
		print("<b>Za traženi datum (". date_format($trazeniDat, 'd/m/Y') . ") nema narudžbenica!</b><br>");
	} 
	else
	{
		?>
